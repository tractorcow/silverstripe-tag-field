...
class TagField extends DropdownField {
	 ...
	 */
	public function __construct($name, $title = null, $source = array(), $value = '', $relationTitleField = null, $form = null, $emptyString = null) {
		$this->relationTitleField = $relationTitleField;

		parent::__construct($name, $title, $source, $value, $form, $emptyString); // TODO: Change the autogenerated stub
	}
